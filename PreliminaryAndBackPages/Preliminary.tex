...
\printbibliography[keyword={included_manuscript}, heading=none]
...
\noindent
Data for this research comes from the Ausphon Lexicon database \autocite{round_ausphon-lexicon_2017}, which is designed and maintained by Erich Round and extends the CHIRILA database \autocite{bowern_chirila:_2016}.\\

\noindent
Additional data, methodological advice and feedback on manuscripts come from Claire Bowern, Simon Greenhill, Gabriel Hassler, David Nash, Caleb Everett, Steven Moran and two anonymous reviewers. These contributions are detailed further at the beginning of each chapter, where applicable.
